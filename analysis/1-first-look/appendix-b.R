...
# ---- data-phase-5 -----------------------
# Phase 5
drop_items_5 <- c("foc_18","foc_16","foc_49","foc_27","foc_28","foc_05")
items_phase_5 <- setdiff(items_phase_0, drop_items_5)
R5 <- make_cor(ds, metaData, items_phase_5)


items_5 <- R5
n.items_5 <- sample_size
p.items_5 <- nrow(R5)
...
# ----- publisher --------------------
path <- "./reports/appendix-b/appendix-b-0.Rmd"
path <- "./reports/appendix-b/appendix-b-5.Rmd"
rmarkdown::render(
  input = path ,
  output_format=c(
    "html_document"
